...
public class Heap<AnyType extends Comparable<AnyType>> implements Iterable<AnyType>
{
	...
	public Iterator<AnyType> iterator() {
		return new HeapIterator<AnyType>(this);
	}
	
	private class HeapIterator<N extends Comparable<N>> implements Iterator{
		private int index;
		private Heap<N> heap;
		
		public HeapIterator(Heap<N> hp) {
			heap = hp;
			index = 1;
		}
